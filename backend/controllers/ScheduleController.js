...
class ScheduleController {
    ...
    get_schedule_by_groupId = async (req, res, next) => {
        try {
            ...
            next(e.message.includes("Navigation timeout of 3000 ms exceeded") || e.message.includes("net::ERR")? ApiError.ServiceUnavailable("Сайт КарГУ не отвечает", [e.stack]) : e)
